...
<form method="POST" id="form2" autocomplete="off" enctype="multipart/form-data">
      ...
      <div class="form-row">
        ...
        <button type="submit" class="btn" id="submit" name="reset">Edit</button>
        <p style="font-size: 14px; color: grey; margin-top: 5px;">*Untuk mengganti tempat perusahaan karyawan bekerja. Anda harus mengganti kode perusahaan. Jika Anda tidak hafal dengan kode perusahaan, dapat dilihat di sini.</p>
    </form>
<?php
	}
?>