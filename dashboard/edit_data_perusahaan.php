...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="stylesheet" href="../css/edit_data_perusahaan.css">
	<script type="text/javascript">
	    ...
	    if(str.length == 0){
				...
				xmlhttp.open("GET","get_namaPerusahaan.php?nama="+str,true);
				xmlhttp.send();
			}
		}
	</script>
...
<body>
	<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width:200px;" id="mySidebar">
		...
		<div id="demoAcc3" class="w3-hide w3-white w3-card">
		    ...
		    <a href="edit_data_perusahaan.php" class="w3-bar-item w3-button" id="active"><li>Perusahaan</li></a>
		</div>
	...
	<?php
		$sql = "SELECT * FROM profile_perusahaan";
	...
	<?php
		...
		if(isset($_POST['reset'])) {
			$updateNamaPerusahaan = $_POST['namaBaru'];
			$idPerusahaan = $_POST['idPerusahaan'];
			$sql2 = "UPDATE profile_perusahaan SET namaPerusahaan = '$updateNamaPerusahaan' WHERE idPerusahaan = '$idPerusahaan'";
			$query2 = mysqli_query($connection, $sql2);
			if ($query2 == true) {
				echo "<script>alert('Nama perusahaan berhasil diedit!')</script>";
	?>
			<script type="text/javascript">location.assign('edit_data_perusahaan.php')</script>
	<?php
			} 
			else {
