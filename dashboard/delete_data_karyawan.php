...
<html>
<head>
	<title>Hapus Data Pekerja</title>
	<meta charset="utf-8">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="stylesheet" href="../css/delete_data_karyawan.css">
	<script type="text/javascript">
	    ...
	    if(str.length == 0){
				...
				xmlhttp.open("GET","get_namaKaryawan2.php?nama="+str,true);
				xmlhttp.send();
			}
		}
	</script>
...
<body>
	<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width:200px;" id="mySidebar">
		...
		<div id="demoAcc3" class="w3-hide w3-white w3-card">
		    <a href="edit_data_karyawan.php" class="w3-bar-item w3-button"><li>Pekerjaan</li></a>
		    <a href="edit_data_perusahaan.php" class="w3-bar-item w3-button"><li>Perusahaan</li></a>
		</div>
		<a href="delete_data_karyawan.php" class="w3-bar-item w3-button" id="active">Hapus Data Pekerja</a>
	...
	<div class="w3-main" style="margin-left:200px">
		<div class="w3-teal">
		  	...
		  	<div class="w3-container">
		    	<h1>Hapus Data Pekerja Pihak Ke-3</h1>
		 	 </div>
		</div>
	...
	<?php
		...
		if(isset($_POST['delete'])) {
			...
			$sql2 = "DELETE FROM profile_pekerja WHERE idPekerja = '$idPekerja'";
			$query2 = mysqli_query($connection, $sql2); 
			if ($query2 == true) {
				echo "<script>alert('Data pekerja berhasil dihapus!')</script>";
			} else {
				echo "<script>alert('Data pekerja gagal dihapus!')</script>";
			}
		}
	?>
